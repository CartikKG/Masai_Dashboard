let allAssignment = JSON.parse(localStorage.getItem("allAssignment")) || [];
display(allAssignment);
...
function displayandsetdata() {
  ...
  console.log("ok");
  let name = document.getElementById("Assingment-name").value;
  let instuctor = document.getElementById("Instuctor-name").value;
  let time = document.getElementById("time").value;
  let date = document.getElementById("date").value;
  let allAssignment = JSON.parse(localStorage.getItem("allAssignment")) || [];
  let newlec = new Assignment(name, instuctor, time, date);
  allAssignment.push(newlec);
  localStorage.setItem("allAssignment", JSON.stringify(allAssignment));
  display(allAssignment);
}
